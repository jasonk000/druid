...
| `parsingThreadCount`              | Integer        | Number of threads that will be used for parsing ingested records from Kafka. Setting 1-N for N threads. 0 (or less) to use the value of `Runtime.availableProcessors()`. If missing, the default is 1.                                                                                                                                                                                                                                                                                                                                                                                                                                              | no (default == 1)                                                                                            |
